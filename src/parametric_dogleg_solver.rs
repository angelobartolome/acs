...
impl ParametricDogLegSolver {
    ...
    fn build_system_parametric(
        ...
        for c in constraints {
            let r = c.residual_parametric(param_manager);
            let j = c.jacobian_parametric(param_manager);
...
// For now, make the ParametricDogLegSolver also implement the Solver trait
