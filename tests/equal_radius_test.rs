...
fn test_equal_radius_constraint_jacobian() {
    ...
    let c1_radius_idx = param_manager.get_global_index("c1", 0).expect("Circle c1 should exist in parameter manager");
    ...
    let c2_radius_idx = param_manager.get_global_index("c2", 0).expect("Circle c2 should exist in parameter manager");
